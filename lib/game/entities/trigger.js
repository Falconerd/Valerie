...
ig.module(
    ...
    .defines(function() {
        ...
        EntityTrigger = ig.EmberEntity.extend({
            size: {
                x: 16,
                y: 16
            },
            ...
            type: ig.EmberEntity.TYPE.NONE,
            checkAgainst: ig.EmberEntity.TYPE.A,
            collides: ig.Entity.COLLIDES.NEVER,


            init: function(x, y, settings) {
                if (settings.checks) {
                    this.checkAgainst = ig.EmberEntity.TYPE[settings.checks.toUpperCase()] || ig.EmberEntity.TYPE.A;
