        ...
        ig.Entity.inject({
            ...
            update: function() {
                ...
                if (this.currentAnim) {
                    ...
                    if (!this.isometricShape) this.currentAnim.angle = this.angle;
                }
            },
            ...
            createBody: function(friction) {
                ...
                if (!this.isometricShape) {

                    vertices.push(new Box2D.Common.Math.b2Vec2(-width * .5, height * .5));
                    vertices.push(new Box2D.Common.Math.b2Vec2(width * .5, height * .5));
                    vertices.push(new Box2D.Common.Math.b2Vec2(width * .5, -height * .5));
                    vertices.push(new Box2D.Common.Math.b2Vec2(-width * .5, -height * .5));
                    ...
                    vertices.push(new Box2D.Common.Math.b2Vec2(width * .5, height * .25));
                    vertices.push(new Box2D.Common.Math.b2Vec2(0, height * .5));
                    vertices.push(new Box2D.Common.Math.b2Vec2(-width * .5, height * .25));
            ...
            _setMass: function(mass) {
                ...
                data.center = new Box2D.Common.Math.b2Vec2(
                    (this.size.x / 2) * Box2D.SCALE, (this.size.y / 2) * Box2D.SCALE
                );
                data.mass = mass;
