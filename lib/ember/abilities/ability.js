ig.module('ember.abilities.ability')
    .requires(
    ...
    .defines(function() {
         ...
         * @type {[type]}
         */
        ig.EmberAbility = ig.Class.extend({
            ...
            /**
             * Whether this ability is currently toggled on.
             * @type {Boolean}
             */
            toggled: false,
            ...
            /**
             * Time since this ability was casted.
             * @type {[type]}
             */
            lastCast: null,
            ...
            activate: function() {
                ...
                if (this.caster.isCasting) return;

                if (this.lastCast.delta() < _c.ABILITY.GLOBAL_COOLDOWN) return;

                if (this.cooldownTimer) {

                    if (this.cooldownTimer.delta() < this.cooldown) return;

                    if (this.toggle) {

                            if (this.toggled) this.cooldownTimer.reset();
