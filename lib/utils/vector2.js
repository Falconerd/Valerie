ig.module(
    ...
    .defines(function() {
         ...
         **/
        ig.utils.vector2.vector = function(x, y, v) {

            v = v || {};

            ig.utils.vector2.set(v, x || 0, y || 0);
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.set = function(v, x, y) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.setScalar = function(v, s) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.clone = function(v) {

            return ig.utils.vector2.vector(v.x, v.y);
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.copy = function(a, b) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.zero = function(v) {
         ...
         **/
        ig.utils.vector2.isZero = function(v) {
         ...
         **/
        ig.utils.vector2.isAlmostZero = function(v) {
         ...
         **/
        ig.utils.vector2.equal = function(a, b) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.inverse = function(v) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.add = function(a, b) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.addVectors = function(a, b) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.addScalar = function(v, s) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.subtract = function(a, b) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.subtractVectors = function(a, b) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.subtractScalar = function(v, s) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.multiply = function(a, b) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.multiplyVectors = function(a, b) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.multiplyScalar = function(v, s) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.divide = function(a, b) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.divideVectors = function(a, b) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.divideScalar = function(v, s) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.min = function(a, b) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.max = function(a, b) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.abs = function(v) {
         ...
         **/
        ig.utils.vector2.length = function(v) {
         ...
         **/
        ig.utils.vector2.lengthSquared = function(v) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.normalize = function(v) {

            var length = ig.utils.vector2.length(v);
         ...
         **/
        ig.utils.vector2.dot = function(a, b) {
         ...
         **/
        ig.utils.vector2.cross = function(a, b) {
         ...
         * @returns {Number} cross product
         **/
        ig.utils.vector2.crossVF = function(v, s) {
         ...
         * @returns {Number} cross product
         **/
        ig.utils.vector2.crossFV = function(v, s) {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         */
        ig.utils.vector2.rotate = function(v, angle, originX, originY) {
         ...
         **/
        ig.utils.vector2.projectPoints = function(points, offsetX, offsetY, scaleX, scaleY, angle, angleOffsetX, angleOffsetY) {
            ...
            if (angle !== 0) {
                ...
                for (i = 0, il = points.length; i < il; i++) {
                    ...
                    point = points[i];
                    pointRotated = ig.utils.vector2.rotate(point, angle, angleOffsetX, angleOffsetY);
                    pointsProjected[i] = {
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         **/
        ig.utils.vector2.centerOfPoints = function(points) {
         ...
         **/
        ig.utils.vector2.pointsCW = function(p1, p2, p3) {
         ...
         **/
        ig.utils.vector2.radianBetweenPoints = function(a, b, c) {
         ...
         **/
        ig.utils.vector2.pointsToConvexHull = function(points) {
            ...
            for (i = 3, il = points.length; i <= il; i++) {
                ...
                while (ig.utils.vector2.pointsCW(pointsByAngle[loc - 1], pointsByAngle[loc], pointsByAngle[i]) <= 0) {
         ...
         * @type {number}
         * @see ig.utils.vector2.pointQuadrant
         */
        ig.utils.vector2.Q_1 = 1;
         ...
         **/
        ig.utils.vector2.pointQuadrant = function(x, y, originX, originY) {
            ...
            if (dx === 0 && dy === 0) {
                ...
                q = ig.utils.vector2.Q_1 | ig.utils.vector2.Q_2 | ig.utils.vector2.Q_3 | ig.utils.vector2.Q_4;

            } else if (dx === 0) {

                if (dy < 0) q = ig.utils.vector2.Q_3 | ig.utils.vector2.Q_4;
                else q = ig.utils.vector2.Q_1 | ig.utils.vector2.Q_2;

            } else if (dy === 0) {

                if (dx < 0) q = ig.utils.vector2.Q_2 | ig.utils.vector2.Q_4;
                else q = ig.utils.vector2.Q_1 | ig.utils.vector2.Q_3;
         ...
         * @returns {Vector2|Object} 2d vector or plain object with properties of a 2d vector
         */
        ig.utils.vector2.directionThreshold = function(v, thresholdX, thresholdY) {
         ...
         * @see ig.utils.vector2.DIRECTION
         */
        ig.utils.vector2.directionToString = function(v) {
            ...
            for (var direction in ig.utils.vector2.DIRECTION) {

                var dv = ig.utils.vector2.DIRECTION[direction];
         ...
         * @see ig.utils.vector2.directionToString
         */
        ig.utils.vector2.DIRECTION = {
            NONE: ig.utils.vector2.vector(),
            LEFT: ig.utils.vector2.vector(-1, 0),
            RIGHT: ig.utils.vector2.vector(1, 0),
            UP: ig.utils.vector2.vector(0, -1),
            DOWN: ig.utils.vector2.vector(0, 1),
            UPLEFT: ig.utils.vector2.vector(-1, -1),
            UPRIGHT: ig.utils.vector2.vector(1, -1),
            DOWNLEFT: ig.utils.vector2.vector(-1, 1),
            DOWNRIGHT: ig.utils.vector2.vector(1, 1)
        };
