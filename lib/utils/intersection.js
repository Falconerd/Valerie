ig.module(
    ...
    .defines(function() {
         ...
         * @memberof ig
         * @namespace ig.utils.intersection
         * @author Collin Hover - collinhover.com
         **/
        ig.utils.intersection = {};
         ...
         * @example
         * // get bounds
         * var bounds = ig.utils.intersection.bounds( 0, 0, 100, 100 );
         * // left
         * bounds.minX;
         * // right
         * bounds.maxX;
         ...
         * bounds.height;
         **/
        ig.utils.intersection.bounds = function(x, y, width, height, bounds) {
         ...
         * @example
         * // get bounds
         * var bounds = ig.utils.intersection.boundsMinMax( 0, 0, 100, 100 );
         * // left
         * bounds.minX;
         * // right
         * bounds.maxX;
         ...
         * bounds.height;
         **/
        ig.utils.intersection.boundsMinMax = function(minX, minY, maxX, maxY, bounds) {
         ...
         * @example
         * // get bounds
         * var bounds = ig.utils.intersection.boundsOfPoints( [
         *      {x: 0, y: 0},
         *      {x: 100, y: 0},
         *      {x: 100, y: 100},
         *      {x: 0, y: 100}
         ...
         * bounds.height;
         **/
        ig.utils.intersection.boundsOfPoints = function(points, bounds) {
         ...
         * @see ig.utils.intersection.bounds
         **/
        ig.utils.intersection.boundsClone = function(boundsSource, offsetX, offsetY, bounds) {
         ...
         * @see ig.utils.intersection.bounds
         **/
        ig.utils.intersection.boundsCopy = function(boundsA, boundsB, offsetX, offsetY, scaleX, scaleY) {
         ...
         * @see ig.utils.intersection.bounds
         **/
        ig.utils.intersection.boundsCopyX = function(boundsA, boundsB, offsetX, scaleX) {
         ...
         * @see ig.utils.intersection.bounds
         **/
        ig.utils.intersection.boundsCopyY = function(boundsA, boundsB, offsetY, scaleY) {
         ...
         */
        ig.utils.intersection.boundsCopyRotated = function(boundsA, boundsB, angle) {
         ...
         **/
        ig.utils.intersection.AABBContains = function(aminX, aminY, amaxX, amaxY, bminX, bminY, bmaxX, bmaxY) {
         ...
         **/
        ig.utils.intersection.AABBIntersect = function(aminX, aminY, amaxX, amaxY, bminX, bminY, bmaxX, bmaxY) {
         ...
         * @returns {Boolean} whether bounds intersect
         * @see ig.utils.intersection.AABBIntersect
         **/
        ig.utils.intersection.boundsIntersect = function(boundsA, boundsB) {
         ...
         * @see ig.utils.intersection.AABBIntersect
         **/
        ig.utils.intersection.boundsAABBIntersect = function(bounds, minX, minY, maxX, maxY) {
         ...
         * @see ig.utils.intersection.AABBIntersect
         **/
        ig.utils.intersection.pointInAABB = function(x, y, minX, minY, maxX, maxY) {
         ...
         * @see ig.utils.intersection.AABBIntersect
         **/
        ig.utils.intersection.pointInBounds = function(x, y, bounds) {
         ...
         **/
        ig.utils.intersection.pointInCircle = function(x, y, cx, cy, radius) {
         ...
         **/
        ig.utils.intersection.pointInPolygon = function(x, y, vertices) {
         ...
         */
        ig.utils.intersection.entitiesInAABB = function(minX, minY, maxX, maxY, targetable, layerName, unsorted) {
            ...
            if (!layerName) {
                ...
                for (i = 0, il = ig.game.layers.length; i < il; i++) {
                    ...
                    if (layer.name && layer.numEntities && (!targetable || layer.itemsTargetable.length)) {
                        ...
                        intersected = intersected.concat(ig.utils.intersection.entitiesInAABB(minX, minY, maxX, maxY, targetable, layer.name, true));
                ...
                for (i = 0, il = entities.length; i < il; i++) {
                    ...
                    if (entity.fixed) {
                        ...
                        intersects = ig.utils.intersection.AABBIntersect(
            ...
            if (intersected.length > 1 && !unsorted) {
                ...
                ig.utils.intersection.sortByDistance(minX + (maxX - minX) * 0.5, minY + (maxY - minY) * 0.5, intersected);
         ...
         **/
        ig.utils.intersection.getIsAABBInScreen = function(x, y, width, height) {

            var adjustedX = x - ig.game.screen.x;
            var adjustedY = y - ig.game.screen.y;

            return ig.utils.intersection.AABBIntersect(adjustedX, adjustedY, adjustedX + width, adjustedY + height, 0, 0, ig.system.width, ig.system.height);
         ...
         **/
        ig.utils.intersection.sortByDistance = function(x, y, entities) {

            var pos = _utv2.set(ig.utils.intersection._utilVec2Sort, x, y);
        ...
        ig.utils.intersection._utilVec2Sort = {
            x: 0.1,
            y: 0.1
        };
